# Docs-as-System VS Code Extension Release Guide

This document explains step by step how to publish a new version of the extension to the VS Code Marketplace.

---

## Before you begin

To publish an extension to the VS Code Marketplace you need:

• A Personal Access Token (PAT) from Azure DevOps with Marketplace permissions  
• The publishing tool installed:
```bash
